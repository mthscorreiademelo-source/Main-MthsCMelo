...
- ✍️ **Desenhos à mão** — segundo tipo de nota, feito para stylus: caneta com **pressão**, 4 cores (incl. marca-texto), 3 espessuras, borracha por traço, desfazer e limpar; palm rejection (dedo rola a página após a caneta ser detectada); traços salvos como vetores + miniatura na lista
