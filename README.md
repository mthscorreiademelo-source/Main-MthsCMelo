...
- 🙂 **Humor** — diário inteligente de humor (redesign completo, estilo diário premium) com **navegação própria por barra inferior**: **Hoje** (humor do dia, sequência, gráfico dos últimos 14 dias, insight de padrão), **Novo Registro** em etapas curtas (5 rostos exclusivos do app → intensidade → emoções → fatores em grupos recolhíveis → nota + foto/desenho), **Linha do Tempo** (todos os registros em cards com rosto, tags, nota e miniatura; abrir para editar/excluir). Vários registros por dia; humores e fatores personalizáveis por categoria. Calendário, Insights e Estatísticas chegam nas próximas etapas
